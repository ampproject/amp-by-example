...
// 	profile := Profile{HashId: "1234"}
// 	return CommentAuthorizationResponse{User: true, Profile: profile}
// }
//
// func (h CommentAuthorizationResponse) CreateInvalidAuthorizationResponse() AuthorizationResponse {
// 	profile := Profile{HashId: "1234"}
// 	return CommentAuthorizationResponse{User: false, Profile: profile}
// }
//
// type Comment struct {
// 	Text     string
